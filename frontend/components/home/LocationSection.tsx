...
const LocationSection: React.FC = () => {
  return (
    <div
      id="location-section"
      className="scroll-mt-24 py-16 sm:py-20 bg-stone-50"
    >
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      <p className="text-emerald-300 text-xs font-semibold mb-0.5">교회</p>
                      <p className="font-medium text-base sm:text-lg text-white/90">
                        kansasfgc@gmail.com
                      </p>
                    </div>
                    <div>
                      <p className="text-emerald-300 text-xs font-semibold mb-0.5">담임목사</p>
                      <p className="font-medium text-base sm:text-lg text-white/90">
                        fg76220@gmail.com
                      </p>
                    </div>
