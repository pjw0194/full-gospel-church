		...
		<section className="py-20 bg-white">
			<div className="container mx-auto px-4">
				<div className="flex justify-between items-end mb-10">
					<div>
						<h2 className="text-3xl font-bold text-stone-900">교회 소식</h2>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
					{news.map((item, idx) => (
						<div key={idx} className="group cursor-pointer">
							{/* 썸네일 영역 */}
							<div className="h-48 bg-stone-200 rounded-xl mb-4 overflow-hidden">
								{/* 이미지 들어갈 곳 */}
								<div className="w-full h-full bg-stone-300 group-hover:scale-105 transition duration-500" />
							</div>
							<span className="text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded">
								{item.tag}
							</span>
							<h3 className="text-xl font-bold text-stone-900 mt-2 group-hover:text-emerald-600 transition">
								{item.title}
							</h3>
