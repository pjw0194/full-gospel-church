...
export default function DailyVerse() {
	...
	return (
		<section className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
			<div className="bg-emerald-50/80 backdrop-blur-xl rounded-3xl sm:rounded-[2.5rem] p-8 sm:p-10 md:p-16 text-emerald-900 relative overflow-hidden shadow-xl border border-emerald-100/50">
