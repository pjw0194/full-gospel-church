      ...
      <div className="container mx-auto flex flex-col items-center justify-between gap-6 px-4 md:flex-row">
        ...
        <div className="flex space-x-4">
          <a
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full bg-stone-800 text-stone-400 transition-all duration-300 hover:scale-110 hover:bg-emerald-600 hover:text-white"
